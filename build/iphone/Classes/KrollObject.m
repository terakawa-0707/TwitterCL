...
//@interface TwitterCLObject : NSObject
//@end

@interface TwitterCLObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TwitterCLObject class]])
		{
			for (NSString *key in [[(TwitterCLObject*)o modules] allKeys])
			{
