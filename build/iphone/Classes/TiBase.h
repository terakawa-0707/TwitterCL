...
// in simulator we redefine to format for TwitterCL Developer console
...
{\
	NSString * exceptionName = [@"org.twittercl." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.twittercl";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITwitterCLNativeItemNone = -1, 
	UITwitterCLNativeItemSpinner = -2,
	UITwitterCLNativeItemProgressBar = -3,
	
	UITwitterCLNativeItemSlider = -4,
	UITwitterCLNativeItemSwitch = -5,
	UITwitterCLNativeItemMultiButton = -6,
	UITwitterCLNativeItemSegmented = -7,
	
	UITwitterCLNativeItemTextView = -8,
	UITwitterCLNativeItemTextField = -9,
	UITwitterCLNativeItemSearchBar = -10,
	
	UITwitterCLNativeItemPicker = -11,
	UITwitterCLNativeItemDatePicker = -12,
	
	UITwitterCLNativeItemInfoLight = -13,
	UITwitterCLNativeItemInfoDark = -14,
	
	UITwitterCLNativeItemDisclosure = -15,
	
	UITwitterCLNativeItemContactAdd = -16
};
